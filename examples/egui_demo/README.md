...
### Issues
- Currently images are set to a fixed size (150x150). I'd prefer to set a max height and then preserve aspect ratio but things got janky when I tried to measure the image sizes later. If someone more familiar with egui can resolve this, please open a pr!
